...
body_declaration1 : EPSILON | TK_PAR_IZQ body_declaration11;
...
separate_optional : TK_SEPARA | EPSILON;
...
cycle : TK_COMA cycles | EPSILON;
cycle_body : variable_instance2 TK_ASIG term TO term;


terms_to_terms : term TO term terms_to_term;
terms_to_term : TK_COMA terms_to_terms | EPSILON;




returns_rule : RETURNS ID | EPSILON;
procedure_reserved_word : PROC | PROCESS;




operation_end : TK_COR_IZQ operation_type_declaration TK_COR_DER | RETURNS ID TK_DOS_PUNTOS operation_end1 |  EPSILON;
operation_end1 :  var_type | ID;
type_specification : ids_group TK_DOS_PUNTOS var_type type_specification1;
type_specification1 :  TK_PUNTO_Y_COMA type_specification |TK_COMA type_specification |  EPSILON;
...
type_specification_op : ID type_specification_op1 | EPSILON;
type_specification_op1 :  TK_DOS_PUNTOS ids_group_dos_puntos type_specification_op | TK_COMA type_specification_op |  EPSILON;
...
type_specification_op_2 : ids_group_dos_puntos type_specification_op_21 | EPSILON;
type_specification_op_21 :  TK_COMA type_specification_op_2 |  TK_DOS_PUNTOS type_specification_op_2 | EPSILON;
...
array : TK_COR_IZQ ids_group TK_COR_DER | EPSILON;

expression : expression boolean_expression | expression arithmethic_expression | EPSILON;
...
fnp_parameter_type_111 : TK_PUNTO ID fnp_parameter_type_1111 | call_function_in_function fnp_parameter_type_11 | TK_COMA fnp_parameter_type_1 | EPSILON;
fnp_parameter_type_1111 : call_function_in_function fnp_parameter_type_11 | fnp_parameter_type_11;
fnp_parameter_type_11 : EPSILON  | TK_COMA fnp_parameter_type_1;
...
expression_variable :  EPSILON | TK_ASIG arithmethic_expression;
...
boolean_expression11 : op_binario_boolean term | EPSILON;


variable_instance : ID variable_instance1;
variable_instance1 : TK_PUNTO ID | TK_MENOS_MENOS | TK_SUMA_SUMA | EPSILON
...
array_declarations : array_declarations array | EPSILON ;
...
variable_declaration11 : TK_DOS_PUNTOS var_type | EPSILON ;
...
variable_instance21 : TK_PUNTO ID variable_instance2 | EPSILON;
...
parameter_call_function : ID parameter_call_function11 | EPSILON;
parameter_call_function11 : parameter_call_function1 | TK_PUNTO ID parameter_call_function1 | EPSILON;
parameter_call_function1 : TK_COMA parameter_call_function | EPSILON;
...
ids_type_group1 : TK_COMA ids_type_group | EPSILON;


ids_group : ID ids_group1;
ids_group1 : TK_COMA ids_group | EPSILON;


ids_group_dos_puntos : ID ids_group_dos_puntos1 | var_type ids_group_dos_puntos11  | EPSILON;
ids_group_dos_puntos11 : ids_group_dos_puntos1 | TK_PAR_IZQ ids_group_dos_puntos TK_PAR_DER ids_group_dos_puntos1 | EPSILON;
ids_group_dos_puntos1 :  TK_COMA ids_group_dos_puntos | TK_DOS_PUNTOS ids_group_dos_puntos |  TK_PUNTO_Y_COMA ids_group_dos_puntos  |  EPSILON;
...
ids_group_dos_puntos_op_type : ID ids_group_dos_puntos_op_type1 | var_type ids_group_dos_puntos_op_type1 | EPSILON;
ids_group_dos_puntos_op_type1 : TK_DOS_PUNTOS ids_group_dos_puntos_op_type |  TK_PUNTO_Y_COMA ids_group_dos_puntos_op_type  |  TK_PUNTO_Y_COMA ids_group_dos_puntos_op_type | EPSILON;
